...
dataset_dir = root + 'datasets/datasets_NovelObjects_CategoryLabels'
...
save_log_dir = root + 'logs/inception_v3_retrained_category_short'

#dataset_name = 'objects_view'
dataset_name = 'objects_category'

...
load_log_dir = root + 'logs/inception_v3_retrained_category_short'

#save_eval_dir = root + 'logs/inception_v3_retrained_category_long_EVAL'
save_eval_dir = root + 'logs/inception_v3_retrained_category_short_EVAL'

#save_weights_dir=  root + 'weights/inception_v3_retrained_category_long'
...
tf.app.flags.DEFINE_integer(
    'batch_size',12*12, 'The number of samples in each batch.')

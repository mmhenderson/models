...
# ==============================================================================
"""Evaluate model to get its performance at a given training step (on imagenet dataset).
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    image_preprocessing_fn = preprocessing_biasCNN.get_preprocessing(
        preprocessing_name,is_training=False, flipLR=False,random_scale=False, 
	    is_windowed=True)

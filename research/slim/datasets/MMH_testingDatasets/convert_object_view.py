...
def _get_dataset_filename(dataset_dir, split_name, num_shards, shard_id):
  output_filename = 'object_view_%s_%05d-of-%05d.tfrecord' % (
...
def main(argv):
  ...
  dataset_dir = '/usr/local/serenceslab/maggie/tensorflow/novel_objects/datasets/datasets_NovelObjects_XYRotationLabels/'
...
#  _clean_up_temporary_files(dataset_dir)
  print('\nFinished converting the novel object dataset, with XY-Rotation labels!')

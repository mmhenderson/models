...
def _get_dataset_filename(dataset_dir, split_name, num_shards, shard_id):
  output_filename = 'grating_orient_smallbatches_%s_%05d-of-%05d.tfrecord' % (
...
def main(argv):
  ...
  dataset_dir = '/usr/local/serenceslab/maggie/biasCNN/datasets/datasets_Grating_Orient_smallbatches/'
